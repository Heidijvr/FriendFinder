...
This FriendFinder application is a compatibility-based dating app. It uses a survey to gain information; then compares the user's input, and finds the best match between individuals. The name and the picture of the best matched individual gets displayed in a modal.
